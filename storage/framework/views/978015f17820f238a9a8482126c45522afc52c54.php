<header class="header shop">
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        <?php
                            $settings=DB::table('settings')->get();
                        ?>                    
                        <a href="<?php echo e(route('home')); ?>"><img src="https://omega-id.herokuapp.com//storage/photos/1/logo.PNG" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
    ...
    <!--/ End Header Inner -->
</header><?php /**PATH E:\IF\Laravel_Project\Omega-ID\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>